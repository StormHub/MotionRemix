...
namespace MotionRemix.Common
{
	...
	public static class MathExtensions
	{
        ...
        private static float FloatEpsilon = 1.192092896e-07F;
		...
		/// <summary>
		///     IsCloseTo - Returns whether or not two doubles are "close".  That is, whether or
		///     not they are within epsilon of each other.  Note that this epsilon is proportional
		///     to the numbers themselves to that AreClose survives scalar multiplication.
		///     There are plenty of ways for this to return false even for numbers which
		///     are theoretically identical, so no code calling this should fail to work if this
        ...
        public static bool AreClose(float a, float b)
        {
            ...
            float eps = ((float)Math.Abs(a) + (float)Math.Abs(b) + 10.0f) * FloatEpsilon;
            float delta = a - b;
            return (-eps < delta) && (eps > delta);
        }

        /// <summary>
        ///     IsCloseTo - Returns whether or not two float are "close".  That is, whether or
        ///     not they are within epsilon of each other.
        /// </summary>
        /// <returns>
        ///     bool - the result of the AreClose comparision.
        ...
        ///     The second double to compare.
        /// </param>
        public static bool IsCloseTo(this float a, float b)
        {
            return AreClose(a, b);
        }
		...
		{
			return AreClose(vector1, vector2);
		}
        ...
        {
            return (float)Math.Abs(value - 1.0f) < (10.0f * FloatEpsilon);
        }
        ...
        {
            return (float)Math.Abs(value) < (10.0f * FloatEpsilon);
        }
		...
		///     bool - the result of the AreClose comparision.
		/// </returns>
		public static bool IsEqualOrCloseToZero(this double value)
		{
			return IsZero(value);
		}
		...
		/// <summary>
		///     Test to see if a <see cref="Size"/> a valid size value (is finite and > 0).
		/// </summary>
		/// <param name='size'>
		///     The <see cref="Size"/> to test.
		/// </param>
		/// <returns>
		///     Whether or not the value is a valid size.
		/// </returns>
		public static bool IsValid(Size size)
		{
			return size.Width.IsValidSizeValue() 
				&& size.Height.IsValidSizeValue();
		}
		...
		///     Whether or not the value is a valid size.
		/// </returns>
		public static bool IsValieSize(this Size size)
		{
			return IsValid(size);
		}
		...
		///     Whether or not the value is a valid size value.
		/// </returns>
		public static bool IsValidSizeValue(this double value)
		{
		...
		///     True if <paramref name="value" /> is not a number. Otherwise true.
		/// </returns>
		public static bool IsNaNValue(this double value)
		{
			return IsNaN(value);
		}
		...
		/// </param>
		/// <returns>
		///     Parameter a or b, whichever is larger. If a, b, or both a and b are equal to <see cref="F:System.Double.NaN" />,
		...
		/// </param>
		/// <returns>
		///     Parameter a or b, whichever is larger. If a, or b, or both a and b are equal to <see cref="F:System.Single.NaN" />,
		...
		/// </param>
		/// <param name="b">
		///     The second of two <see cref="T:System.Decimal" />
		///     numbers to compare.
		/// </param>
		/// <returns>
		///     Parameter a or b, whichever is smaller.
		...
		/// </param>
		/// <returns>
		///     Parameter a or b, whichever is smaller. If a, b, or both a and b are equal to <see cref="F:System.Double.NaN" />,
		///     <see cref="F:System.Double.NaN" /> is returned.
		/// </returns>
		[SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
		...
		/// </param>
		/// <returns>
		///     Parameter a or b, whichever is smaller. If a, b, or both a and b are equal to <see cref="F:System.Single.NaN" />,
		///     <see cref="F:System.Single.NaN" /> is returned.
		/// </returns>
		[SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
		...
		/// </summary>
		/// <returns>
		///     The integer nearest parameter value. If value is halfway between two integers, one of which is even and the other
		...
		/// </summary>
		/// <returns>
		///     The integer nearest value. If value is halfway between two integers, one of which is even and the other odd, then
		...
		/// </summary>
		/// <returns>
		///     The number nearest value with a precision equal to decimals. If value is halfway between two numbers, one of which
		///     is even and the other odd, then the even number is returned. If the precision of value is less than decimals, then
		...
		/// </summary>
		/// <returns>
		///     The integer nearest value. If value is halfway between two numbers, one of which is even and the other odd, then
		...
		///     mode is not a valid value of <see cref="T:System.MidpointRounding" />.
		/// </exception>
		...
		/// </summary>
		/// <returns>
		///     The number nearest value with a precision equal to digits. If value is halfway between two numbers, one of which is
		///     even and the other odd, then the even number is returned. If the precision of value is less than digits, then value
		...
		/// <summary>
		///     Rounds a double-precision floating-point value to the nearest integer. A parameter specifies how to round the value
		...
		/// <returns>
		///     The number nearest value with a precision equal to decimals. If value is halfway between two numbers, one of which
		///     is even and the other odd, then mode determines which of the two numbers is returned. If the precision of value is
		///     less than decimals, then value is returned unchanged.
		/// </returns>
		/// <param name="value">
		///     A decimal number to be rounded.
		/// </param>
		...
		/// <summary>
		///     Rounds a double-precision floating-point value to the specified precision. A parameter specifies how to round the
		///     value if it is midway between two other numbers.
		/// </summary>
		/// <returns>
		///     The number nearest value with a precision equal to digits. If value is halfway between two numbers, one of which is
		///     even and the other odd, then the mode parameter determines which number is returned. If the precision of value is
		...
		public static double RoundUp(this double value, double factor)
		{
			...
			return IsZero(d) ? value : value < 0 ? value - d : value + (factor - d);
		}
		...
		/// </returns>
		/// <param name="value">
		///     A number in the range <see cref="F:System.Double.MinValue" /> ≤ value ≤ <see cref="F:System.Double.MaxValue" />.
		/// </param>
		...
		/// </returns>
		/// <param name="value">
		///     A number in the range <see cref="F:System.Single.MinValue" /> ≤ value ≤ <see cref="F:System.Single.MaxValue" />.
		/// </param>
		...
		/// </returns>
		/// <param name="value">
		///     A number in the range <see cref="F:System.Int16.MinValue" /> &lt; value ≤ <see cref="F:System.Int16.MaxValue" />.
		/// </param>
		/// <exception cref="T:System.OverflowException">
		///     value equals <see cref="F:System.Int16.MinValue" />.
		/// </exception>
		...
		/// </returns>
		/// <param name="value">
		///     A number in the range <see cref="F:System.Int32.MinValue" /> &lt; value ≤ <see cref="F:System.Int32.MaxValue" />.
		/// </param>
		/// <exception cref="T:System.OverflowException">
		///     value equals <see cref="F:System.Int32.MinValue" />.
		/// </exception>
		...
		/// </returns>
		/// <param name="value">
		///     A number in the range <see cref="F:System.Int64.MinValue" /> &lt; value ≤ <see cref="F:System.Int64.MaxValue" />.
		/// </param>
		/// <exception cref="T:System.OverflowException">
		///     value equals <see cref="F:System.Int64.MinValue" />.
		/// </exception>
		...
		/// </returns>
		/// <param name="value">
		///     A number in the range <see cref="F:System.SByte.MinValue" /> &lt; value ≤ <see cref="F:System.SByte.MaxValue" />.
		/// </param>
		/// <exception cref="T:System.OverflowException">
		///     value equals <see cref="F:System.SByte.MinValue" />.
		/// </exception>
		//[CLSCompliant(false)]
		...
		/// </summary>
		/// <returns>
		///     The <see cref="T:System.Int64" /> containing the product of the specified numbers.
		/// </returns>
		/// <param name="a">
		///     The first <see cref="T:System.Int32" /> to multiply.
		/// </param>
		/// <param name="b">
		///     The second <see cref="T:System.Int32" /> to multiply.
		/// </param>
		[SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
		...
		/// </summary>
		/// <returns>
		///     The <see cref="T:System.Int32" /> containing the quotient of the specified numbers.
		/// </returns>
		/// <param name="a">
		///     The <see cref="T:System.Int32" /> that contains the dividend.
		/// </param>
		/// <param name="result">
		///     The <see cref="T:System.Int32" /> that receives the remainder.
		/// </param>
		/// <param name="b">
		///     The <see cref="T:System.Int32" /> that contains the divisor.
		/// </param>
		...
		/// </summary>
		/// <returns>
		///     The <see cref="T:System.Int64" /> containing the quotient of the specified numbers.
		/// </returns>
		/// <param name="a">
		///     The <see cref="T:System.Int64" /> that contains the dividend.
		/// </param>
		/// <param name="result">
		///     The <see cref="T:System.Int64" /> that receives the remainder.
		/// </param>
		/// <param name="b">
		///     The <see cref="T:System.Int64" /> that contains the divisor.
		/// </param>
		/// <exception cref="T:System.DivideByZeroException">
		///     b is zero.
		/// </exception>
...
// ReSharper disable once InconsistentNaming
		...
		/// </summary>
		/// <returns>
		///     See <see cref="Math.Log10" /> for details.
		/// </returns>
		/// <param name="value">
		///     A number whose logarithm is to be found.
		/// </param>
		...
		/// </summary>
		/// <returns>
		///     The number x raised to the power y. See <see cref="Math.Pow" /> for details.
		/// </returns>
		/// <param name="y">
		...
		/// </summary>
		/// <returns>
		///     A number indicating the sign of value.Number Description -1 value is less than zero. 0 value is equal to zero. 1
		...
		///     value is equal to <see cref="F:System.Double.NaN" />.
		/// </exception>
		...
		/// </param>
		/// <exception cref="T:System.ArithmeticException">
		///     value is equal to <see cref="F:System.Single.NaN" />.
		/// </exception>
		...
		/// </summary>
		/// <returns>
		///     <see cref="Math.Sqrt" /> for details.
		/// </returns>
		/// <param name="value">
		///     A number.
		/// </param>
		...
		/// </summary>
		/// <returns>
		///     true if value evaluates to not a number (<see cref="F:System.Single.NaN" />); otherwise, false.
		/// </returns>
		/// <param name="value">
		...
		/// </summary>
		/// <returns>
		///     The value of the <paramref name="value" /> parameter if it doesn't evaluate to <see cref="F:System.Double.NaN" />;
		///     otherwise, 0.0.
		/// </returns>
		/// <param name="value">
		///     A double-precision floating-point number.
		...
		///     The value to return if IsNaN returns true.
		/// </param>
		...
		/// </summary>
		/// <returns>
		///     The value of the <paramref name="value" /> parameter if it doesn't evaluate to <see cref="F:System.Single.NaN" />;
		///     otherwise, 0.0.
		/// </returns>
		/// <param name="value">
		///     A single-precision floating-point number.
		...
		/// </summary>
		/// <returns>
		///     An angle, θ, measured in radians, such that 0 ≤ θ ≤ π -or- <see cref="F:System.Double.NaN" /> if value &lt; -1 or
		///     value &gt; 1.
		/// </returns>
		/// <param name="value">
		...
		/// </summary>
		/// <returns>
		///     An angle, θ, measured in radians, such that -π/2 ≤ θ ≤ π/2 -or- <see cref="F:System.Double.NaN" /> if value &lt; -1
		///     or value &gt; 1.
		/// </returns>
		/// <param name="value">
		...
		/// </summary>
		/// <returns>
		///     An angle, θ, measured in radians, such that -π/2 ≤ θ ≤ π/2 -or- <see cref="F:System.Double.NaN" /> if value equals
		///     <see cref="F:System.Double.NaN" />, -π/2 rounded to double precision (-1.5707963267949) if value equals
		...
		/// </summary>
		/// <returns>
		///     The hyperbolic tangent of angle. If angle is equal to <see cref="F:System.Double.NegativeInfinity" />, this method
		///     returns -1. If angle is equal to <see cref="F:System.Double.PositiveInfinity" />, this method returns 1. If angle
		///     is equal to <see cref="F:System.Double.NaN" />, this method returns <see cref="F:System.Double.NaN" />.
		/// </returns>
		/// <param name="angle">
		///     An angle, measured in radians.
		/// </param>
		...
		/// </summary>
		/// <returns>
		///     A sequence of numbers from start to (but not including) bound where each number is a given step greater than the
		///     previous number.
		/// </returns>
		/// <param name="start">
		///     The number to start from.
		...
		{
			short step = start <= bound ? (short) 1 : (short) -1;
